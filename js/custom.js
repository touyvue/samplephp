...
$(document).ready(function(){
  ...
  //setTimeout(function() {noty({text: '<strong>Howdy! How can I help you?</strong>',layout:'topRight',type:'alert',timeout:13000});}, 9000);
...
$(function() {
    $('#deldatetimepicker').datetimepicker({pickTime: false});
});
