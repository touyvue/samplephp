<?php
	...
	include('m_momax/setting/con_log/log_tagset.php'); 
?>
                ...
                <div class="col-md-8">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-head">
                          <div class="pull-left">Tag Setting</div>
                        ...
                        <div class="widget-content referrer">
                          ...
                          <div class="widget-foot"><?php echo $tagListAdd ?></div>
                        </div>
                        <!-- End widget-content -->
                    </div>
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                              <div class="modal-header">
                                ...
                                <h4 class="modal-title"><span id="eActTit">Tag</span></h4>
                              </div>
                                    ...
                                    <!-- Form starts.  -->
                                     <form class="form-horizontal" role="form">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-lg-7">
                                           	<div class="radio">
                                              <label><input type="radio" name="activeTag" id="activeTag1" value="yes" checked="yes" > Yes</label>&nbsp;&nbsp;
                                              <label><input type="radio" name="activeTag" id="activeTag2" value="no" > No</label>
                                            </div>
                                          </div>
                                        </div>
                                        ...
                                        <input type="hidden" id="edtTagID" name="edtTagID" value="" />
	                                      </form>
                                  </div>
                                <!-- form -->
                              ...
                              <div class="modal-footer">
                                <button type="button" id="insertNewTag" class="btn btn-primary"><span id="eActType"></span></button>
                              </div>
                            </div>
                        </div>
                    </div>
