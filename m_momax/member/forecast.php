<?php
	...
	include('m_momax/member/con_log/log_forecast.php'); 
?>
                ...
                <div class="col-md-8">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-head">
                          <div class="pull-left">Individual Budgeting</div>
                        ...
                        <div class="widget-content">
                            <div class="padd">
                              <strong>Budget Name:</strong> <?php echo $budgetName?><br /><strong>Period:</strong> <?php echo $startDate?> - <?php echo $endDate?>
                              <hr />
                                  ...
                                  <table cellpadding="0" cellspacing="0" border="0" id="forecast_detail" width="100%" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                          ...
                                          <th class="nsort">Budget</th>
                                          <th class="nsort">Actual</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                      <?php echo $memberList ?>
                                    ...
                                    <tfoot>
                                    	<tr>
                                          ...
                                          <th><span id="forecasttotal" class='sinform-mem-tot'><?php echo $allTotAmount?></span></th>
                                          <th><span id="trackacttotal" class='sinform-mem-tot'><?php echo $allActTotAmount?></span>
                                        </tr>
                                    </tfoot>
                                  </table>
                              </div>
