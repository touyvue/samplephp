<?php
	...
	include('m_momax/report/con_log/log_rpt001tagr.php'); 
?>
...
<div class="content">
    ...
    <!-- Sidebar ends -->
  	...
  	<div class="mainbar">
	    <!-- Begin breadcrumb1 -->
            <div class="page-head">
              <h2 class="pull-left"><a href="index.php"><i class="fa fa-home"></i></a> <a href="<?php echo $mx004tg?>">Reports</a></h2>
                ...
                <div class="col-md-8">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-head">
                          <div class="pull-left"><span class="rpt-tit" id="active_rpt">Tag Report: </span></div>
