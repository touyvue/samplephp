<?php
	...
	include('m_momax/report/con_log/log_index.php'); 
?>
...
<div class="content">
    ...
    <!-- Sidebar ends -->
  	...
  	<div class="mainbar">
	    <!-- Begin breadcrumb1 -->
            <div class="page-head">
              <h2 class="pull-left"><a href="index.php"><i class="fa fa-home"></i></a> <a href="<?php echo $mx005 ?>">Reports</a></h2>
                        ...
                        <div class="widget-content referrer">
                              <div class="table-responsive">
                                  <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                      <td><a href="#">No reports available</a></td>
                                      <td></td>
                                    </tr>
                                  </table>
                              </div>
