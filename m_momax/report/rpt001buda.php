<?php
	...
	include('m_momax/report/con_log/log_rpt001buda.php'); 
?>
                ...
                <div class="col-md-8">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-content referrer">
                                <br />
                                <form class="form-horizontal" role="form" action="#" name="budget_rpt_frm" id="budget_rpt_frm" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                      <label class="col-lg-3 control-label">Choose Budget:</label>
                                      <div class="col-lg-5">
                    ...
                    <div class="widget">
                        <!-- Begin widget-head -->
                        <div class="widget-head">
                          <div class="pull-left"><span class="rpt-tit">Report Name: </span><?php echo $reportName; ?> </div>
                          <div class="widget-icons pull-right">
                            <a href="#" class="wminimize"><i class="fa fa-chevron-up"></i></a> 
                            <a href="#" class="wclose"><i class="fa fa-times"></i></a>
                          </div>  
                              ...
                              <div class="table-responsive">
                                  <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php if ($incomeAmtList != ""){ ?>
                                        ...
                                        <tr>
									<?php } ?>
										<?php if ($expenseAmtList != ""){ ?>
                                            <th colspan="5">Expense Category</th>
                                            </tr>
                                        <?php echo $expenseAmtList; ?>
									<?php } ?>
                                    <tr>
                                      	<th colspan="4">Net Balance</th>
                                      	<th><?php echo $grandBalance ?></th>
                                    </tr>
                                  </table>
                              </div>
